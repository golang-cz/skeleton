// Skeleton  85d8bb8a51b0ef8a2465bf6f9d6669b315aa5354
// --
...
func WebRPCSchemaHash() string {
	return "85d8bb8a51b0ef8a2465bf6f9d6669b315aa5354"
}
...
func NewSkeletonServer(svc Skeleton) *skeletonServer {
	return &skeletonServer{
		Skeleton: svc,
	}
}

func (s *skeletonServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
	...
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "Skeleton")

	var handler func(ctx context.Context, w http.ResponseWriter, r *http.Request)
	switch r.URL.Path {
	case "/rpc/Skeleton/GetUser": handler = s.serveGetUserJSON
	default:
...
func (s *skeletonServer) serveGetUserJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	ret0, err := s.Skeleton.GetUser(ctx, reqPayload.Arg0)
	if err != nil {
...
func (s *skeletonServer) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		 s.OnError(r, &rpcErr)
	}
